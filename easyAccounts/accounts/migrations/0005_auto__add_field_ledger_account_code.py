...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ledger.account_code'
        db.add_column(u'accounts_ledger', 'account_code',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Ledger.account_code'
        db.delete_column(u'accounts_ledger', 'account_code')
