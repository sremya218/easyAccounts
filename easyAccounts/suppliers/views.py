    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.is_ajax():
            ...
            if request.GET.get('pdf', ''):
                ...
                data = []
                data.append(['Sl No.', 'Name', 'Dr','Cr'])
                table = Table(data, colWidths=(50, 200, 100, 100), rowHeights=25, style=style)
                ...
                for supplier in suppliers:
                    ...
                    data.append([i, Paragraph(supplier.name, para_style), debit_balance, credit_balance])
                table = Table(data, colWidths=(50, 200, 100, 100),style=style)
                table.setStyle([('ALIGN',(0,0),(-1,-1),'LEFT'),
                    ('TEXTCOLOR',(0,0),(-1,-1),colors.black),
                    ('VALIGN',(0,0),(-1,-1),'MIDDLE'),
                    ('BACKGROUND',(0, 0),(-1,-1),colors.white),
