...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.supplier_tin'
        db.add_column(u'purchases_purchase', 'supplier_tin',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Purchase.owner_tin'
        db.add_column(u'purchases_purchase', 'owner_tin',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Purchase.supplier_tin'
        db.delete_column(u'purchases_purchase', 'supplier_tin')

        # Deleting field 'Purchase.owner_tin'
        db.delete_column(u'purchases_purchase', 'owner_tin')
