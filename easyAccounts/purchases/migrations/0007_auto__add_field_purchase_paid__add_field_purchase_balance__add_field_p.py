...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'purchases_purchase', 'paid')

        # Deleting field 'Purchase.balance'
        db.delete_column(u'purchases_purchase', 'balance')
    ...
    models = {
        ...
        u'purchases.purchase': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_payment_completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
