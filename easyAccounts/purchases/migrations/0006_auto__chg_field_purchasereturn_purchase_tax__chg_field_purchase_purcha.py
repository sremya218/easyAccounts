...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurchaseReturn.purchase_tax'
        db.alter_column(u'purchases_purchasereturn', 'purchase_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'Purchase.purchase_tax'
        db.alter_column(u'purchases_purchase', 'purchase_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))
    def backwards(self, orm):

        # Changing field 'PurchaseReturn.purchase_tax'
        db.alter_column(u'purchases_purchasereturn', 'purchase_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=5))

        # Changing field 'Purchase.purchase_tax'
        db.alter_column(u'purchases_purchase', 'purchase_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=5))
    models = {
        u'accounts.ledger': {
