...
class PurchaseItem(models.Model):
    ...
    def get_json_data(self):
        purchase_item_data = {
            ...
            'item_name': self.batch_item.item.name,
    ...
    def set_attributes(self, batch_item, quantity, purchase_item_data, purchase_unit, unit_item_discount, batch_item_created):
        ...
        if batch_item_created:
            batch_item.quantity_in_purchase_unit = purchase_item_data['quantity']
...
class PurchaseReturn(models.Model):
    ...
    def get_json_data(self):
        ...
        purchase_return_data = {
            ...
            'discount': self.discount,
            'grant_total': self.grant_total,
            'supplier': self.purchase.supplier.name,
            'transaction_ref': self.transaction_reference_no,
    ...
    def set_attributes(self, purchase_return_details, transaction_reference_no):
        ...
        for pr_item in purchase_return_items:
            ...
            batch_item.quantity_in_purchase_unit= float(batch_item.quantity_in_purchase_unit) - float(return_item.quantity)
            quantity_in_smallest_unit = float(purchase_item.quantity_in_smallest_unit) * float(return_item.quantity)
            batch_item.quantity_in_smallest_unit = float(batch_item.quantity_in_smallest_unit) - float(quantity_in_smallest_unit)
            batch_item.save() 
...
class PurchaseReturnItem(models.Model):
    ...
    def get_json_data(self):
        ...
        purchase_return_item_data = {
            ...
            'stock': self.purchase_item.batch_item.quantity_in_purchase_unit,
