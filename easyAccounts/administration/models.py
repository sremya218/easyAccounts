...
class Staff(models.Model):
    ...
    def get_json_data(self):
        ...
        staff_data = {
            ...
            'suppliers': 'true' if self.permission and self.permission.suppliers else 'false',
            'customers': 'true' if self.permission and self.permission.customers else 'false',
        }
        return staff_data
...
class SerialNoInvoice(models.Model):
    ...
    def __unicode__(self):
        return self.prefix + " " + self.starting_no
