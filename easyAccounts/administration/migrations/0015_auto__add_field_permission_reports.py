...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Permission.reports'
        db.add_column(u'administration_permission', 'reports',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Permission.reports'
        db.delete_column(u'administration_permission', 'reports')
    ...
    models = {
        ...
        u'administration.permission': {
            ...
            'reports': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
