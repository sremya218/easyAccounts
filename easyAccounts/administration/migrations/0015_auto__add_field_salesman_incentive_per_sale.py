...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Salesman.incentive_per_sale'
        db.add_column(u'administration_salesman', 'incentive_per_sale',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2, blank=True),
                      keep_default=False)
    def backwards(self, orm):
        # Deleting field 'Salesman.incentive_per_sale'
        db.delete_column(u'administration_salesman', 'incentive_per_sale')
