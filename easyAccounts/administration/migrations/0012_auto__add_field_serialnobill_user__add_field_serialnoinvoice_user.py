...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SerialNoBill.user'
        db.add_column(u'administration_serialnobill', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SerialNoInvoice.user'
        db.add_column(u'administration_serialnoinvoice', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SerialNoBill.user'
        db.delete_column(u'administration_serialnobill', 'user_id')

        # Deleting field 'SerialNoInvoice.user'
        db.delete_column(u'administration_serialnoinvoice', 'user_id')
    ...
    models = {
        ...
        u'administration.serialnobill': {
            ...
            'starting_no': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
