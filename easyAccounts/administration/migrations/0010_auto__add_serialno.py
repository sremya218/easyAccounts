...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'administration_serialno', (
            ...
            ('starting_no', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
        ))
        db.send_create_signal(u'administration', ['SerialNo'])

    def backwards(self, orm):
        # Deleting model 'SerialNo'
        db.delete_table(u'administration_serialno')
    ...
    models = {
        ...
        u'administration.serialno': {
            'Meta': {'object_name': 'SerialNo'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
