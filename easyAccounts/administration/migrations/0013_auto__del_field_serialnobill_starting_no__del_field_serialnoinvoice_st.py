...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SerialNoBill.starting_no'
        db.delete_column(u'administration_serialnobill', 'starting_no')

        # Deleting field 'SerialNoInvoice.starting_no'
        db.delete_column(u'administration_serialnoinvoice', 'starting_no')

    def backwards(self, orm):
        # Adding field 'SerialNoBill.starting_no'
        db.add_column(u'administration_serialnobill', 'starting_no',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'SerialNoInvoice.starting_no'
        db.add_column(u'administration_serialnoinvoice', 'starting_no',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)
