...
from sales.models import Sale, SalesItem, Estimate, EstimateItem, Receipt, Invoice, SalesReturn, SalesReturnItem, EditedReceipt ,EditedInvoice, EditedInvoiceSaleItem, EditedInvoiceSale, DeliveryNote, DeliverynoteItem
