...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstimateItem.price_type'
        db.add_column(u'sales_estimateitem', 'price_type',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EstimateItem.price_type'
        db.delete_column(u'sales_estimateitem', 'price_type')
