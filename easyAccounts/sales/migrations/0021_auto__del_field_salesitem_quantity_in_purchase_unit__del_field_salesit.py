...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SalesItem.quantity_in_purchase_unit'
        db.delete_column(u'sales_salesitem', 'quantity_in_purchase_unit')

        # Deleting field 'SalesItem.quantity_in_smallest_unit'
        db.delete_column(u'sales_salesitem', 'quantity_in_smallest_unit')

    def backwards(self, orm):
        # Adding field 'SalesItem.quantity_in_purchase_unit'
        db.add_column(u'sales_salesitem', 'quantity_in_purchase_unit',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10),
                      keep_default=False)

        # Adding field 'SalesItem.quantity_in_smallest_unit'
        db.add_column(u'sales_salesitem', 'quantity_in_smallest_unit',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10),
                      keep_default=False)
