...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'sales_sale', 'salesman_bonus_point',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='Salesman Bonus Point', null=True, to=orm['administration.BonusPoint'], blank=True),
                      keep_default=False)

        # Adding field 'Sale.customer_bonus_point'
        db.add_column(u'sales_sale', 'customer_bonus_point',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='Customer Bonus Point', null=True, to=orm['administration.BonusPoint'], blank=True),
                      keep_default=False)
