...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sales_sale', 'paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Sale.balance'
        db.add_column(u'sales_sale', 'balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Sale.ispayment_completed'
        db.add_column(u'sales_sale', 'ispayment_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sale.paid'
        db.delete_column(u'sales_sale', 'paid')

        # Deleting field 'Sale.balance'
        db.delete_column(u'sales_sale', 'balance')

        # Deleting field 'Sale.ispayment_completed'
        db.delete_column(u'sales_sale', 'ispayment_completed')
    ...
    models = {
        ...
        u'sales.sale': {
            ...
            'grant_total': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ispayment_completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
