...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sales_deliverynote', (
            ...
            ('salesman', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.Salesman'], null=True, blank=True)),
            ('do_number', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('bill_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('deliverynote_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('auto_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
            ('deliverynote_invoice_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('is_converted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        ...
        db.create_table(u'sales_deliverynoteitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('delivery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.DeliveryNote'], null=True, blank=True)),
            ...
            ('price_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        db.create_table(u'sales_sale', (
            ...
            ('deliverynote', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.DeliveryNote'], null=True, blank=True)),
            ('sales_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ...
            ('round_off', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2)),
            ('cess', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2)),
            ('sales_tax', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2)),
            ('customer_tin', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('owner_tin', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('customer_bonus_point_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2)),
            ('salesman_bonus_point_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2)),
        ))
        ...
        db.create_table(u'sales_salesitem', (
            ...
            ('mrp', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10)),
            ('net_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10)),
            ('quantity_in_purchase_unit', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10)),
        ...
        db.create_table(u'sales_receipt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sales', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Sale'])),
            ('receipt_no', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'sales', ['Receipt'])

        # Adding model 'Invoice'
        db.create_table(u'sales_invoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sales', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Sale'])),
            ('invoice_no', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
            ('invoice_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'sales', ['Invoice'])

        # Adding model 'Estimate'
        db.create_table(u'sales_estimate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer'], null=True, blank=True)),
            ('salesman', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.Salesman'], null=True, blank=True)),
            ('do_number', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('bill_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('estimate_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('auto_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
            ('estimate_invoice_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('payment_mode', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('bank_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('card_number', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('cheque_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'sales', ['Estimate'])

        # Adding model 'EstimateItem'
        db.create_table(u'sales_estimateitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('estimate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Estimate'], null=True, blank=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True, blank=True)),
            ('batch_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.BatchItem'], null=True, blank=True)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10)),
            ('uom', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal(u'sales', ['EstimateItem'])

        # Adding model 'SalesReturn'
        db.create_table(u'sales_salesreturn', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sales', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Sale'], null=True, blank=True)),
            ('transaction_reference_no', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        db.create_table(u'sales_salesreturnitem', (
            ...
            ('sales_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.SalesItem'])),
            ('uom', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10)),
            ('net_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10)),
        ))
        ...
        # Adding model 'EditedInvoiceSale'
        db.create_table(u'sales_editedinvoicesale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer'], null=True, blank=True)),
            ('salesman', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.Salesman'], null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ...
        db.send_create_signal(u'sales', ['EditedInvoiceSale'])

        # Adding model 'EditedInvoiceSaleItem'
        db.create_table(u'sales_editedinvoicesaleitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('edited_invoice_sales', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.EditedInvoiceSale'])),
            ('batch_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.BatchItem'], null=True, blank=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True, blank=True)),
            ('price_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10)),
        ...
        db.send_create_signal(u'sales', ['EditedInvoiceSaleItem'])

        # Adding model 'EditedReceipt'
        db.create_table(u'sales_editedreceipt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('edited_invoice_sales', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.EditedInvoiceSale'])),
            ('receipt_no', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'sales', ['EditedReceipt'])

        # Adding model 'EditedInvoice'
        db.create_table(u'sales_editedinvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('edited_invoice_sales', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.EditedInvoiceSale'])),
            ('invoice_no', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
            ('invoice_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'sales', ['EditedInvoice'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'sales_receipt')

        # Deleting model 'Invoice'
        db.delete_table(u'sales_invoice')

        # Deleting model 'Estimate'
        db.delete_table(u'sales_estimate')

        # Deleting model 'EstimateItem'
        db.delete_table(u'sales_estimateitem')
        ...
        # Deleting model 'EditedInvoiceSale'
        db.delete_table(u'sales_editedinvoicesale')

        # Deleting model 'EditedInvoiceSaleItem'
        db.delete_table(u'sales_editedinvoicesaleitem')

        # Deleting model 'EditedReceipt'
        db.delete_table(u'sales_editedreceipt')

        # Deleting model 'EditedInvoice'
        db.delete_table(u'sales_editedinvoice')
    ...
    models = {
        ...
        u'inventory.item': {
            ...
            'room_number': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'shelf_number': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        u'sales.sale': {
            ...
            'deliverynote': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sales.DeliveryNote']", 'null': 'True', 'blank': 'True'}),
            'discount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            'do_number': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'grant_total': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
