...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.customer_tin'
        db.add_column(u'sales_sale', 'customer_tin',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sale.owner_tin'
        db.add_column(u'sales_sale', 'owner_tin',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sale.customer_tin'
        db.delete_column(u'sales_sale', 'customer_tin')

        # Deleting field 'Sale.owner_tin'
        db.delete_column(u'sales_sale', 'owner_tin')
