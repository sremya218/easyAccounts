...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeliveryNote.is_converted'
        db.add_column(u'sales_deliverynote', 'is_converted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DeliveryNote.is_converted'
        db.delete_column(u'sales_deliverynote', 'is_converted')
