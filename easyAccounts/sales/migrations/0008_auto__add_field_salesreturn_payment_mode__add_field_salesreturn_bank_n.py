...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesReturn.payment_mode'
        db.add_column(u'sales_salesreturn', 'payment_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SalesReturn.bank_name'
        db.add_column(u'sales_salesreturn', 'bank_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SalesReturn.card_number'
        db.add_column(u'sales_salesreturn', 'card_number',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SalesReturn.cheque_date'
        db.add_column(u'sales_salesreturn', 'cheque_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SalesReturn.cheque_number'
        db.add_column(u'sales_salesreturn', 'cheque_number',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SalesReturn.branch'
        db.add_column(u'sales_salesreturn', 'branch',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SalesReturn.card_holder_name'
        db.add_column(u'sales_salesreturn', 'card_holder_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SalesReturn.payment_mode'
        db.delete_column(u'sales_salesreturn', 'payment_mode')

        # Deleting field 'SalesReturn.bank_name'
        db.delete_column(u'sales_salesreturn', 'bank_name')

        # Deleting field 'SalesReturn.card_number'
        db.delete_column(u'sales_salesreturn', 'card_number')

        # Deleting field 'SalesReturn.cheque_date'
        db.delete_column(u'sales_salesreturn', 'cheque_date')

        # Deleting field 'SalesReturn.cheque_number'
        db.delete_column(u'sales_salesreturn', 'cheque_number')

        # Deleting field 'SalesReturn.branch'
        db.delete_column(u'sales_salesreturn', 'branch')

        # Deleting field 'SalesReturn.card_holder_name'
        db.delete_column(u'sales_salesreturn', 'card_holder_name')
