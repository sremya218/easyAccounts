...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estimate.round_off'
        db.add_column(u'sales_estimate', 'round_off',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Estimate.cess'
        db.add_column(u'sales_estimate', 'cess',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Estimate.round_off'
        db.delete_column(u'sales_estimate', 'round_off')

        # Deleting field 'Estimate.cess'
        db.delete_column(u'sales_estimate', 'cess')
