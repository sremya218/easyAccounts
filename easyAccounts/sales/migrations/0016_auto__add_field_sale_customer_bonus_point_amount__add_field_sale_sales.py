...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.customer_bonus_point_amount'
        db.add_column(u'sales_sale', 'customer_bonus_point_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Sale.salesman_bonus_point_amount'
        db.add_column(u'sales_sale', 'salesman_bonus_point_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sale.customer_bonus_point_amount'
        db.delete_column(u'sales_sale', 'customer_bonus_point_amount')

        # Deleting field 'Sale.salesman_bonus_point_amount'
        db.delete_column(u'sales_sale', 'salesman_bonus_point_amount')
