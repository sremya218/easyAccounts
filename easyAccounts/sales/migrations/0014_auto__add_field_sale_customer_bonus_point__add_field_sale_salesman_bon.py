...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.customer_bonus_point'
        db.add_column(u'sales_sale', 'customer_bonus_point',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Customer Bonus Point', null=True, to=orm['administration.BonusPoint']),
                      keep_default=False)

        # Adding field 'Sale.salesman_bonus_point'
        db.add_column(u'sales_sale', 'salesman_bonus_point',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Salesman Bonus Point', null=True, to=orm['administration.BonusPoint']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sale.customer_bonus_point'
        db.delete_column(u'sales_sale', 'customer_bonus_point_id')

        # Deleting field 'Sale.salesman_bonus_point'
        db.delete_column(u'sales_sale', 'salesman_bonus_point_id')
    ...
    models = {
        ...
        u'sales.sale': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customers.Customer']", 'null': 'True', 'blank': 'True'}),
            'customer_bonus_point': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Customer Bonus Point'", 'null': 'True', 'to': u"orm['administration.BonusPoint']"}),
            ...
            'salesman': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['administration.Salesman']", 'null': 'True', 'blank': 'True'}),
            'salesman_bonus_point': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Salesman Bonus Point'", 'null': 'True', 'to': u"orm['administration.BonusPoint']"}),
            'transaction_reference_no': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'sales.salesitem': {
