...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BatchItem.customer_bonus_quantity'
        db.alter_column(u'inventory_batchitem', 'customer_bonus_quantity', self.gf('django.db.models.fields.FloatField')(max_length=100, null=True))

        # Changing field 'BatchItem.quantity_in_purchase_unit'
        db.alter_column(u'inventory_batchitem', 'quantity_in_purchase_unit', self.gf('django.db.models.fields.FloatField')(max_length=100))

        # Changing field 'BatchItem.salesman_bonus_quantity'
        db.alter_column(u'inventory_batchitem', 'salesman_bonus_quantity', self.gf('django.db.models.fields.FloatField')(max_length=100, null=True))

        # Changing field 'BatchItem.quantity_in_smallest_unit'
        db.alter_column(u'inventory_batchitem', 'quantity_in_smallest_unit', self.gf('django.db.models.fields.FloatField')(max_length=100))

        # Changing field 'BatchItem.quantity_in_actual_unit'
        db.alter_column(u'inventory_batchitem', 'quantity_in_actual_unit', self.gf('django.db.models.fields.FloatField')(max_length=100))
    def backwards(self, orm):

        # Changing field 'BatchItem.customer_bonus_quantity'
        db.alter_column(u'inventory_batchitem', 'customer_bonus_quantity', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'BatchItem.quantity_in_purchase_unit'
        db.alter_column(u'inventory_batchitem', 'quantity_in_purchase_unit', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=5))

        # Changing field 'BatchItem.salesman_bonus_quantity'
        db.alter_column(u'inventory_batchitem', 'salesman_bonus_quantity', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'BatchItem.quantity_in_smallest_unit'
        db.alter_column(u'inventory_batchitem', 'quantity_in_smallest_unit', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=5))

        # Changing field 'BatchItem.quantity_in_actual_unit'
        db.alter_column(u'inventory_batchitem', 'quantity_in_actual_unit', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=5))
    models = {
        ...
        u'inventory.batchitem': {
            ...
            'quantity_in_purchase_unit': ('django.db.models.fields.FloatField', [], {'default': '0', 'max_length': '100'}),
            'quantity_in_smallest_unit': ('django.db.models.fields.FloatField', [], {'default': '0', 'max_length': '100'}),
