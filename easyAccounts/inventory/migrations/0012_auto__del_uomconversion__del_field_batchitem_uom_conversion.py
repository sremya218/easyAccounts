...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BatchItem.uom_conversion'
        db.delete_column(u'inventory_batchitem', 'uom_conversion_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BatchItem.uom_conversion'
        db.add_column(u'inventory_batchitem', 'uom_conversion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.UOMConversion'], null=True, blank=True),
                      keep_default=False)
