...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BatchItem.batch_price'
        db.add_column(u'inventory_batchitem', 'batch_price',
    ...
    def backwards(self, orm):
        # Deleting field 'BatchItem.batch_price'
        db.delete_column(u'inventory_batchitem', 'batch_price')
