...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.room_number'
        db.add_column(u'inventory_item', 'room_number',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.shelf_number'
        db.add_column(u'inventory_item', 'shelf_number',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Item.room_number'
        db.delete_column(u'inventory_item', 'room_number')

        # Deleting field 'Item.shelf_number'
        db.delete_column(u'inventory_item', 'shelf_number')
