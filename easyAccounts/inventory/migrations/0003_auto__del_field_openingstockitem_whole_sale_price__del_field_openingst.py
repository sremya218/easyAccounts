...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OpeningStockItem.whole_sale_price'
        db.delete_column(u'inventory_openingstockitem', 'whole_sale_price')

        # Deleting field 'OpeningStockItem.retail_price'
        db.delete_column(u'inventory_openingstockitem', 'retail_price')

    def backwards(self, orm):
        # Adding field 'OpeningStockItem.whole_sale_price'
        db.add_column(u'inventory_openingstockitem', 'whole_sale_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

        # Adding field 'OpeningStockItem.retail_price'
        db.add_column(u'inventory_openingstockitem', 'retail_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)
